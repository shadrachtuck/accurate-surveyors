...
- Cron-based automation for plugin/theme management and log sending
- Admin settings page with toggles and intervals for cron jobs
...
3. Configure settings via the "Thrive Security" menu in the WordPress Admin.
...
* Added Default Cron Interval to Twice Daily on plugin activation.
* Remove Required Plugins Notice

= 1.0.09 =
* Remove Unnecessary Padding.
* Remove Background Color From Heading.
* Remove Background Color From Option Page.
* Remove Dark Mode CSS

= 1.0.08 =
* Javascript loading problem solved.

= 1.0.2 =
* Improved cron job scheduling: first run is now delayed by the selected interval (not immediate).
* Cron jobs are now always cleared immediately and reliably when the blocking module is disabled.
* When re-enabling the blocking module:
  * If you only enable, all settings are restored to default.
  * If you enable and change any setting, only changed settings are kept, all others are restored to default.
  * All cron jobs are (re)scheduled with their associated intervals.
* Improved settings logic for restoring defaults and user changes.
* Debug logging added for plugin installation/activation via cron.
...
= 1.0.2 =
This update improves cron job reliability, settings restoration, and overall security enforcement. It is recommended for all users.
