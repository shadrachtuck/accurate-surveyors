<?php
	$wp_customize->add_setting( 'footer_layout', array(
		...
		'default'           => blockchain_footer_layout_default(),
		'sanitize_callback' => 'blockchain_sanitize_footer_layout',
	) );
	...
	$wp_customize->add_control( 'footer_fullwidth', array(
		'type'    => 'checkbox',
		'section' => 'theme_footer_style',
		'label'   => esc_html__( 'Full width footer', 'blockchain' ),
	) );

	$wp_customize->selective_refresh->add_partial( 'theme_footer_layout', array(
		'selector'        => '.footer',
		'render_callback' => 'blockchain_footer',
