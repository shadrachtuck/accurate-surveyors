<?php
	...
	$wp_customize->add_control( 'theme_social_target', array(
		...
		'label'   => esc_html__( 'Open social and sharing links in a new tab.', 'blockchain' ),
	) );
	...
	foreach ( $networks as $network ) {
		...
		$wp_customize->add_control( $social_mod, array(
			...
			'label'   => esc_html( sprintf( _x( '%s URL', 'social network url', 'blockchain' ), $network['label'] ) ),
		) );
	}
