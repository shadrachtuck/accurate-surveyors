...
function blockchain_customize_register( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'theme_style', array(
		'selector'            => '#blockchain-style-inline-css',
		'render_callback'     => 'blockchain_get_all_customizer_css',
		'settings'            => array(),
	...
	// Header
	//
	if ( apply_filters( 'blockchain_customizable_header', true ) ) {
		$wp_customize->add_panel( 'theme_header', array(
			'title'    => esc_html_x( 'Header', 'customizer section title', 'blockchain' ),
			'priority' => 10, // Before site_identity, 20
		) );

		$wp_customize->add_section( 'theme_header_style', array(
			'title'    => esc_html_x( 'Header style', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_header',
			'priority' => 10,
		) );
		...
		$wp_customize->add_section( 'theme_header_top_bar', array(
			'title'    => esc_html_x( 'Top menu bar', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_header',
			'priority' => 20,
		) );
		...
		$wp_customize->add_section( 'theme_header_primary_menu', array(
			'title'    => esc_html_x( 'Primary menu bar', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_header',
			'priority' => 30,
		) );
		require_once get_theme_file_path( 'inc/customizer/theme-header-primary-menu.php' );
	} // filter blockchain_customizable_header
	...
	$wp_customize->add_panel( 'theme_blog', array(
		'title'    => esc_html_x( 'Blog settings', 'customizer section title', 'blockchain' ),
		'priority' => 30, // After site_identity, 20
	) );

	$wp_customize->add_section( 'theme_archive_options', array(
		'title'       => esc_html_x( 'Archive options', 'customizer section title', 'blockchain' ),
		'panel'       => 'theme_blog',
		'description' => esc_html__( 'Customize the default archive pages, such as the blog, category, tag, date archives, etc.', 'blockchain' ),
		'priority'    => 10,
	) );
	...
	$wp_customize->add_section( 'theme_post_options', array(
		'title'    => esc_html_x( 'Post options', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_blog',
		'priority' => 20,
	) );
	...
	$wp_customize->add_panel( 'theme_colors', array(
		'title'    => esc_html_x( 'Colors', 'customizer section title', 'blockchain' ),
		'priority' => 30,
	) );

	if ( apply_filters( 'blockchain_customizable_header', true ) ) {
		$wp_customize->add_section( 'theme_colors_header_top_bar', array(
			'title'    => esc_html_x( 'Header top bar', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_colors',
			'priority' => 10,
		) );
		...
		require_once get_theme_file_path( 'inc/customizer/theme-colors-primary-menu-bar.php' );
	} // filter blockchain_customizable_header

	if ( get_theme_support( 'blockchain-hero' ) ) {
		$wp_customize->add_section( 'theme_colors_hero', array(
			'title'    => esc_html_x( 'Hero', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_colors',
			'priority' => 30,
		) );
	...
	$wp_customize->add_section( 'theme_colors_global', array(
		'title'    => esc_html_x( 'Global', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_colors',
		'priority' => 40,
	) );
	...
	$wp_customize->add_section( 'theme_colors_sidebar', array(
		'title'    => esc_html_x( 'Sidebar', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_colors',
		'priority' => 50,
	) );
	require_once get_theme_file_path( 'inc/customizer/theme-colors-sidebar.php' );

	if ( apply_filters( 'blockchain_customizable_footer', true ) ) {
		$wp_customize->add_section( 'theme_colors_footer', array(
			'title'    => esc_html_x( 'Footer', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_colors',
			'priority' => 60,
		) );
		require_once get_theme_file_path( 'inc/customizer/theme-colors-footer.php' );
	} // filter blockchain_customizable_footer
	...
	$wp_customize->add_panel( 'theme_typography', array(
		'title'    => esc_html_x( 'Typography', 'customizer section title', 'blockchain' ),
		'priority' => 70,
	) );

	$wp_customize->add_section( 'theme_typography_content', array(
		'title'    => esc_html_x( 'Content', 'customizer section title', 'blockchain' ),
	...
	$wp_customize->add_section( 'theme_typography_widgets', array(
		'title'    => esc_html_x( 'Widgets', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_typography',
		'priority' => 20,
	) );
	...
	$wp_customize->add_section( 'theme_social', array(
		'title'       => esc_html_x( 'Social Networks', 'customizer section title', 'blockchain' ),
		'description' => esc_html__( 'Enter your social network URLs. Leaving a URL empty will hide its respective icon.', 'blockchain' ),
		'priority'    => 80,
	) );
	...
	if ( apply_filters( 'blockchain_customizable_footer', true ) ) {
		...
		$wp_customize->add_section( 'theme_footer_style', array(
			'title'    => esc_html_x( 'Footer style', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_footer',
			'priority' => 10,
		) );
		...
		$wp_customize->add_section( 'theme_footer_bottom_bar', array(
			'title'    => esc_html_x( 'Bottom bar', 'customizer section title', 'blockchain' ),
			'panel'    => 'theme_footer',
			'priority' => 20,
		) );
	...
	$wp_customize->add_panel( 'theme_titles', array(
		'title'    => esc_html_x( 'Titles', 'customizer section title', 'blockchain' ),
		'priority' => 100,
	) );

	$wp_customize->add_section( 'theme_titles_general', array(
		'title'    => esc_html_x( 'General', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_titles',
		'priority' => 10,
	) );
	...
	$wp_customize->add_section( 'theme_titles_post', array(
		'title'    => esc_html_x( 'Posts', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_titles',
		'priority' => 20,
	) );
	...
	// Portfolio
	//
	$wp_customize->add_section( 'theme_titles_portfolio', array(
		'title' => esc_html_x( 'Portfolio', 'customizer section title', 'blockchain' ),
		'panel' => 'theme_titles',
	) );
	require_once get_theme_file_path( 'inc/customizer/theme-titles-portfolio.php' );
	...
	$wp_customize->add_section( 'theme_other_sample_content', array(
		'title'    => esc_html_x( 'Sample Content', 'customizer section title', 'blockchain' ),
		'panel'    => 'theme_other',
		'priority' => 10,
	) );
...
add_action( 'customize_register', 'blockchain_customize_register' );



add_action( 'customize_register', 'blockchain_customize_register_custom_controls', 9 );
/**
 * Registers custom Customizer controls.
 *
 * @param WP_Customize_Manager $wp_customize Reference to the customizer's manager object.
 */
function blockchain_customize_register_custom_controls( $wp_customize ) {
 ...
 */
function blockchain_customize_preview_js() {
	$theme = wp_get_theme();

	wp_enqueue_script( 'blockchain-customizer-preview', get_template_directory_uri() . '/js/admin/customizer-preview.js', array( 'customize-preview' ), $theme->get( 'Version' ), true );
	wp_enqueue_style( 'blockchain-customizer-preview', get_template_directory_uri() . '/css/admin/customizer-preview.css', array( 'customize-preview' ), $theme->get( 'Version' ) );
}
add_action( 'customize_preview_init', 'blockchain_customize_preview_js' );

function blockchain_customize_controls_js() {
	$theme = wp_get_theme();
	...
	wp_enqueue_script( 'blockchain-customizer-controls', get_template_directory_uri() . '/js/admin/customizer-controls.js', array(), $theme->get( 'Version' ), true );
}
add_action( 'customize_controls_enqueue_scripts', 'blockchain_customize_controls_js' );
