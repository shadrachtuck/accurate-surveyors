<?php
function blockchain_get_social_networks() {
	return apply_filters( 'blockchain_social_networks', array(
		array(
			'name'  => 'facebook',
			'label' => esc_html__( 'Facebook', 'blockchain' ),
			'icon'  => 'fa-facebook',
		),
		array(
			'name'  => 'twitter',
			'label' => esc_html__( 'Twitter', 'blockchain' ),
			'icon'  => 'fa-twitter',
		),
		array(
			'name'  => 'instagram',
			'label' => esc_html__( 'Instagram', 'blockchain' ),
			'icon'  => 'fa-instagram',
		),
		array(
			'name'  => 'snapchat',
			'label' => esc_html__( 'Snapchat', 'blockchain' ),
			'icon'  => 'fa-snapchat',
		),
		array(
			'name'  => 'bloglovin',
			'label' => esc_html__( 'Bloglovin', 'blockchain' ),
			'icon'  => 'fa-heart',
		),
		array(
			'name'  => 'pinterest',
			'label' => esc_html__( 'Pinterest', 'blockchain' ),
			'icon'  => 'fa-pinterest',
		),
		array(
			'name'  => 'youtube',
			'label' => esc_html__( 'YouTube', 'blockchain' ),
			'icon'  => 'fa-youtube',
		),
		array(
			'name'  => 'vimeo',
			'label' => esc_html__( 'Vimeo', 'blockchain' ),
			'icon'  => 'fa-vimeo',
		),
		array(
			'name'  => 'gplus',
			'label' => esc_html__( 'Google Plus', 'blockchain' ),
			'icon'  => 'fa-google-plus',
		),
		array(
			'name'  => 'linkedin',
			'label' => esc_html__( 'LinkedIn', 'blockchain' ),
			'icon'  => 'fa-linkedin',
		),
		array(
			'name'  => 'tumblr',
			'label' => esc_html__( 'Tumblr', 'blockchain' ),
			'icon'  => 'fa-tumblr',
		),
		array(
			'name'  => 'flickr',
			'label' => esc_html__( 'Flickr', 'blockchain' ),
			'icon'  => 'fa-flickr',
		),
		array(
			'name'  => 'dribbble',
			'label' => esc_html__( 'Dribbble', 'blockchain' ),
			'icon'  => 'fa-dribbble',
		),
		array(
			'name'  => 'wordpress',
			'label' => esc_html__( 'WordPress', 'blockchain' ),
			'icon'  => 'fa-wordpress',
		),
		array(
			'name'  => '500px',
			'label' => esc_html__( '500px', 'blockchain' ),
			'icon'  => 'fa-500px',
		),
		array(
			'name'  => 'soundcloud',
			'label' => esc_html__( 'Soundcloud', 'blockchain' ),
			'icon'  => 'fa-soundcloud',
		),
		array(
			'name'  => 'spotify',
			'label' => esc_html__( 'Spotify', 'blockchain' ),
			'icon'  => 'fa-spotify',
		),
		array(
			'name'  => 'vine',
			'label' => esc_html__( 'Vine', 'blockchain' ),
			'icon'  => 'fa-vine',
		),
		array(
			'name'  => 'tripadvisor',
			'label' => esc_html__( 'Trip Advisor', 'blockchain' ),
			'icon'  => 'fa-tripadvisor',
		),
	) );
}

function blockchain_wp_link_pages_default_args() {
	return apply_filters( 'blockchain_wp_link_pages_default_args', array(
		'before'      => '<div class="page-links">' . esc_html__( 'Pages:', 'blockchain' ),
		'after'       => '</div>',
...
function blockchain_get_video_url_info( $url ) {
 ...
 */
function blockchain_get_related_posts( $post_id, $related_count, $args = array() ) {
 ...
 */
function blockchain_get_page_var( $default_return = 0 ) {
 ...
 */
function blockchain_dropdown_posts( $args = '', $name = 'post_id' ) {
	$defaults = array(
		'depth'                 => 0,
		'post_parent'           => 0,
		'selected'              => 0,
 ...
 */
function blockchain_color_luminance( $color, $percent ) {
	// Remove # if provided
	if ( '#' === $color[0] ) {
 ...
 * @return string
 */
function blockchain_hex2rgba( $color, $opacity = false ) {
...
function blockchain_empty_content( $content = false ) {
	if ( false === $content ) {
		$post    = get_post();
 ...
 * @return string
 */
function blockchain_get_image_lightbox_caption( $image_id = false ) {
	if ( false === $image_id ) {
	...
	if ( is_array( $attachment ) ) {
		$field = apply_filters( 'blockchain_image_lightbox_caption_field', 'caption', $image_id, $attachment );
