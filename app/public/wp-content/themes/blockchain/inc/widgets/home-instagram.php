...
if ( class_exists( 'null_instagram_widget' ) && ! class_exists( 'CI_Widget_Home_Instagram' ) ) :
	class CI_Widget_Home_Instagram extends null_instagram_widget {
		...
		function __construct() {
			$widget_ops  = array( 'description' => esc_html__( 'Homepage widget. Displays your latest Instagram photos. Requires the plugin "WP Instagram Widget" to be active.', 'blockchain' ) );
			$control_ops = array();
			WP_Widget::__construct( 'ci-home-instagram', esc_html__( 'Theme (home) - Instagram', 'blockchain' ), $widget_ops, $control_ops );
		...
		function form( $instance ) {
			...
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'blockchain' ); ?></label><input id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" class="widefat" /></p>
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of photos:', 'blockchain' ); ?></label><input id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" min="1" step="1" value="<?php echo esc_attr( $number ); ?>" class="widefat" /></p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><?php esc_html_e( 'Open links in:', 'blockchain' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'target' ) ); ?>">
					<?php $choices = array(
						'_self'  => esc_html__( 'Current window', 'blockchain' ),
						'_blank' => esc_html__( 'New window', 'blockchain' ),
					); ?>
			...
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>"><?php esc_html_e( 'Link text:', 'blockchain' ); ?></label><input id="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'link' ) ); ?>" type="text" value="<?php echo esc_attr( $link ); ?>" class="widefat" /></p>
