...
//						var_dump( get_theme_mod( 'footer_text_right', blockchain_get_default_footer_text( 'right' ) ) );
//					}
				?>
...
function blockchain_header_right( $layout ) {
	...
	<div class="col-lg-9 col-md-6 col-4">
		...
		<?php if ( ! empty( $menu ) ) : ?>
			<a href="#mobilemenu" class="mobile-nav-trigger"><i class="fa fa-navicon"></i> <?php esc_html_e( 'Menu', 'blockchain' ); ?></a>
		<?php endif; ?>
	</div>
	<?php
}
