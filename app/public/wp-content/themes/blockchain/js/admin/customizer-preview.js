...
(function ($) {
	...
	wp.customize('header_primary_menu_text_on_bg_color', function (value) {
		value.bind(function (to) {
			$('.over-background .site-logo a, ' +
				'.over-background .site-tagline,' +
				'.head-mast.over-background' +
				'.over-background .navigation-main > li > a').css('color', to);
	...
	wp.customize('header_primary_menu_active_color', function (value) {
		value.bind(function (to) {
			$('.navigation-main > li:hover > a, ' +
				...
				'.navigation-main > li > a:hover').css('border-color', to);
		});
	});
	...
	wp.customize('header_primary_submenu_active_text_color', function (value) {
		value.bind(function (to) {
			$('.navigation-main li .current-menu-item > a,' +
				...
				'.navigation-main li .current-menu-ancestor > a').css('background-color', to);
		});
	});
	...
	wp.customize('theme_lightbox', function (value) {
		value.bind(function (to) {
			if (to) {
				...
				$(".blockchain-lightbox, a[data-lightbox^='gal']").off('click');
			}
		});
	});
		...
		value.bind(function (to) {
			createStyleSheet('site_secondary_accent_color', [
				...
				},
				{
					property: 'background-color',
					value: to,
					selectors: '.head-sticky.is-stuck.over-background,' +
					'.item-btn,' +
