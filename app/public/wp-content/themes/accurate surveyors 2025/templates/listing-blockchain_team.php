		...
		<div class="team row">
			...
			<div class="<?php blockchain_the_container_classes(); ?>">
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php
						$data = blockchain_post_type_listing_get_template_data( get_the_ID(), 'blockchain_team' );
					...
					<div class="team row row-items <?php echo esc_attr( implode( ' ', $data['container_classes'] ) ); ?>">
